...
class MLReceivedList extends JFrame implements ActionListener
{
	Connection con;
	Statement stm;
	ResultSet rs;
	...
	Label title=new Label("Monthly Letters Received List");
	JPanel p=new JPanel();
	JScrollPane jsp;
	Container c;
    String ip;
    ...
    MLReceivedList(String s)
 	{
		super("MLReceived List");
        ip=s;
	...
	public void actionPerformed(ActionEvent e)
	{
		try
		{
			...
			if(obj==b1)
			{
                ...
                q="Select * from LettersReceived where Month='"+mn+"'   and Year= '"+yr+"'" ;
